module IPS
    class AllergyIntoleranceCrossBorder < Inferno::TestGroup
      ...
      test do
        title 'Server returns AllergyIntolerance resource that matches the Allergy Intolerance - Cross Border (IPS) profile'
        description %(
          This test will validate that the AllergyIntolerance resource returned from the server matches the Allergy Intolerance - Cross Border (IPS) profile.
        )
        # link 'http://hl7.org/fhir/uv/ips/StructureDefinition/AllergyIntolerance-uv-ips'
